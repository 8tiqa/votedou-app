...
namespace VoteDou
{
    public partial class FrmAdminAdmin : Form
    {
        ...
        private void btnAddNew_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        con.Open();
                        using (SqlCommand com = new SqlCommand("INSERT INTO Administrator (Administrator_ID,FirstName,LastName,CNIC,Contact#,Password) VALUES (NEXT VALUE FOR Admin_ID_Sequence,@firstname,@lastname,@cnic,@contact, NEXT VALUE FOR Admin_Password_Sequence)", con))
                        {
        ...
        {
            // TODO: This line of code loads data into the 'voteDouDataSet.Administrator' table. You can move, or remove it, as needed.
            this.administratorTableAdapter.Fill(this.voteDouDataSet.Administrator);
        ...
        string cons = VoteDou.Properties.Settings.Default.VoteDouConnectionString;
            ...
            {
                connection1.Open();
                string s = "Select * FROM Administrator where Administrator_ID ='" + SearchAdminID.Text + "'";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    connection1.Open();
                    string s = "Delete FROM Administrator where Administrator_ID ='" + SearchAdminID.Text + "'";
                    using (SqlCommand selectCommand = new SqlCommand(s, connection1))
                    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection connection1 = new SqlConnection(cons))
                {
                    ...
                    string s = "Update Administrator set FirstName ='" + EditFirstName.Text + "', LastName ='" + EditLastName.Text +
                    "', CNIC ='" + EditCNIC.Text + "', Contact# ='" + EditContact.Text + "', Password ='" + EditPassword.Text +
                    "'where Administrator_ID ='" + SearchAdminID.Text + "'";
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("select * from Adminstrator", con);
            sda.Fill(dt);
        ...
        private void SearchAdminID_TextChanged(object sender, EventArgs e)
        {
